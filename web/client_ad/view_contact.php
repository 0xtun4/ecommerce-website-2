...
<head>
    ...
    <script src="./js/const3.js?020"></script>
    <script type="text/javascript" src="./js/chat.js?020"></script>
</head>
<body>
<div class="main_content">
    ...
    if (!empty($info)) {
        ...
        $nonmsg = "Không có tin nhăn nào trong 30 ngày vừa qua";
    }
    ?>
    <?php if ($nonmsg === "") : ?>
    <script> sessionStorage.setItem("adm_chat", "admin@admin.com"); </script>
            ...
            <div id="plist" class="people-list">
                <ul class="list-unstyled chat-list mt-2 mb-0">
                    <?php foreach ($info as $key => $val) : ?>
                        <?php if ($key == 0) : ?>
                            <li id="navli<?php echo $val; ?>" class="navli clearfix active"
                                onload=dispnone(<?php echo $val . ',"' . hashroom('id' . $val . SECRET_KEY) . '"'; ?>)
                                onclick=dispnone(<?php echo $val . ',"' . hashroom('id' . $val . SECRET_KEY) . '"'; ?>)>
                                <img src="<?php echo DOMEN . "/css/" . LOGO_COMPANY; ?>" alt="vat">
                                <div class="about">
                                    <div class="name">
                                        id<?php echo $val; ?>
                                    </div>
                        ...
                        <?php else: ?>
                            <li id="navli<?php echo $val; ?>" class="navli clearfix"
                                onclick=dispnone(<?php echo $val . ',"' . hashroom('id' . $val . SECRET_KEY) . '"'; ?>)>
                                <img src="<?php echo DOMEN . "/css/" .LOGO_COMPANY; ?>">
                                <div class="about">
                                    <div class="name">
                                        id<?php echo $val; ?>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#view_info">
                                    <img src="<?php echo DOMEN ."/css/". LOGO_COMPANY; ?>" alt="avatar">
                                </a>
                                ...
                                if ($row['direction'] == 1) {
                                    ...
                                    <li class="clearfix" data-mid="<?php echo $row['id']; ?>">
                                        <div class="message-data">
                                            <img src="<?php echo DOMEN; ?>./css/piccl.png">
                                    ...
                                    <li class="clearfix" data-mid="<?php echo $row['id']; ?>">
                                        <div class="message-data text-right">
                                            ...
                                            <img src="<?php echo DOMEN; ?>./css/techhelp.png">
                                        </div>
                        ...
                        <div class="input-group mb-0">
                            <div class="input-group-prepend">
                                <button class="btn btn-success "
                                        onclick=send(<?php echo $flag . ',"' . hashroom('id' . $flag . SECRET_KEY) . '"'; ?>)>
                                                <span>
                                                    <i class="fa fa-send">
                                                         Gửi
                                                    </i>
                            ...
                            <input type="text" class="form-control msg<?php echo $flag; ?>"
