<?php
	/*************************Default parameters**********************************/
    const SUPER_USER = 'admin';                                       //Superuser/administrator login
    const SECRET_KEY = 'qwerty';                                         //Secret key
    ...
    const DOMEN = 'http://localhost/admin';                                 //URL of the admin panel folder
    const SOCKETIO = 'http://54.254.150.184:3000/socket.io/socket.io.js'; //URL of socket.io library on chat server
